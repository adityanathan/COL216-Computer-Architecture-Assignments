...
signal alu_op_code: std_logic_vector(4 downto 0):="00000";
...
signal instr_decoded: std_logic_vector(3 downto 0):="0000";
signal instr_class: std_logic_vector(2 downto 0):="000";
...
signal exec_state: std_logic_vector(2 downto 0):="000";
signal c_instr_class: std_logic_vector(2 downto 0):="000";
signal control_state: std_logic_vector(3 downto 0):="0000";
...
signal MW, IW, DW, Rsrc, M2R, RW, AW, BW, Asrc1, Fset, ReW: std_logic:='0';
...
IW <= '1' when (control_state="0000") and not(exec_state="100" or exec_state="000") else
      '0';
...
PW <= '1' when (control_state="0000" or (control_state="0100" and not( instr_decoded="0111" or instr_decoded="1000"))) and not(exec_state="100" or exec_state="000") else
      alu_flag_out(1) when (control_state="0100" and instr_decoded="0111") and not(exec_state="100" or exec_state="000") else
      not(alu_flag_out(1)) when (control_state="0100" and instr_decoded="1000") and not(exec_state="100" or exec_state="000") else
      '0';
...
M2R <= '1' when RW = '1' and (control_state="1001") else
             '0';
...
op <= "01" when (control_state="0100") and not(exec_state="100" or exec_state="000") else
      "10" when (control_state="0011") and not(exec_state="100" or exec_state="000") and instr_U = '0' else
      "01" when (control_state="0011") and not(exec_state="100" or exec_state="000") and instr_U = '1' else
      "01" when (control_state="0000" or control_state="0001") and not(exec_state="100" or exec_state="000") else
      "00" when ( control_state="0010" and (instr_decoded="0100") ) and not(exec_state="100" or exec_state="000") else
      "01" when ( control_state="0010" and (instr_decoded="0001" ) ) and not(exec_state="100" or exec_state="000") else
      "11" when ( control_state="0010" and (instr_decoded="0011" ) ) and not(exec_state="100" or exec_state="000") else
      "11" when (control_state = "0010" and (instr_decoded = "0010")) and not(exec_state = "100" or exec_state = "000") else
      "00"; 
...
r_we<=RW;
r_pc_we <= PW ;  
r_pc_in <= alu_result(29 downto 0) & "00" when control_state="0100" and PW = '1'  else
           alu_result(31 downto 0) when control_state = "0000" and PW = '1'  else
...
led <= instr_instruction(31 downto 16) when slide_switches(14 downto 0)="000000000000000" else
       ...
       alu_flag_out & op & "0000000000000" when slide_switches(14 downto 0) = "000000000011000" else
       "1111111111111111";
