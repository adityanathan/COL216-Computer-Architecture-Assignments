...
type instr_decoded_type is (annd, eor, orr, bic, add, sub, adc, sbc, rsb, rsc, cmp, cmn, tst, teq, mov, mvn, ldr, str, beq, bne, b, halted, unknown);
end package;
...
(   instruction: in std_logic_vector(31 downto 0);
    ...
    B_bit: out std_logic;
    W_bit: out std_logic;
    DT_SH_1: out std_logic;
    DT_SH_2: out std_logic
...
i_dec_out<= halted when valid = '0' else
            annd when opcode_for_dp="0000" and F_field="00" else
...
DT_SH_1 <= instruction(7);
DT_SH_2 <= instruction(4);


valid <= '1' when instruction(31 downto 28) = "1110" and instruction(27 downto 26) = "00"  and instruction(25) = '1' else
         '1' when instruction(31 downto 28) = "1110" and instruction(27 downto 26) = "00"  and instruction(25) = '0' and
                        (instruction(4) = '0' or (instruction(4) = '1' and instruction(7) = '0')) else
         '1' when instruction(31 downto 28) = "1110" and instruction(27 downto 25) = "000" and instruction(7) = '1' and 
                        instruction(4) ='1' and (instruction(22) = '0' or (instruction(22) = '1' and instruction(11 downto 8) = "0000")) else
         '1' when instruction(31 downto 28) = "1110" and instruction(27 downto 26) = "01" and (instruction(25) = '0' 
                                or (instruction(25) = '1' and instruction(4) = '0')) else
         '1' when (instruction( 31 downto 28) = "1110" or instruction(31 downto 28) = "0000" or instruction( 31 downto 28) = "0001")
                    and instruction(27 downto 24) = "1010" else
         '0';
