...
HD_PWD='/home/dual/cs5170403/COL216/COL216_assn_5/COL216_assn_5.runs/rom_program_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_program_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_program_memory.tcl
