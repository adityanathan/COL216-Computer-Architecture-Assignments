...
HD_PWD='/home/dual/cs5170403/COL216/COL216_assn_5/COL216_assn_5.runs/ram_data_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_data_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_data_memory.tcl
